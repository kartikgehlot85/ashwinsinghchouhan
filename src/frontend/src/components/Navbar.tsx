          ...
          <div className="flex items-center gap-3">
            {isAdmin ? (
              <div className="hidden lg:flex items-center gap-2">
                <span className="flex items-center gap-1.5 text-xs text-accent border border-accent/30 rounded-full px-3 py-1 bg-accent/10">
              ...
              <Button
                ...
                className="hidden lg:flex items-center gap-2 border-primary/40 text-primary hover:border-primary/70 hover:bg-primary/10 transition-smooth text-xs font-medium"
                  ...
                  <div className="border-t border-border pt-4">
                    {isAdmin ? (
                      ...
                      <Button
                        ...
                        data-ocid="nav.mobile.admin_login_button"
                      >
